...
const revenue1 = document.getElementById("revenue1");
...
const revenue2 = document.getElementById("revenue2");
...
const revenue3 = document.getElementById("revenue3");
...
const revenue4 = document.getElementById("revenue4");
...
const revenue5 = document.getElementById("revenue5");
...
function submitData(e) {
  ...
  console.log(+revenue1.value);
  console.log(+x11.value);
  console.log(+x12.value);
  console.log(+x13.value);
  console.log(+x14.value);
  console.log(+x15.value);

  console.log(+revenue2.value);
  console.log(+x21.value);
  console.log(+x22.value);
  console.log(+x23.value);
  console.log(+x24.value);
  console.log(+x25.value);

  console.log(+revenue3.value);
  console.log(+x31.value);
  console.log(+x32.value);
  console.log(+x33.value);
  console.log(+x34.value);
  console.log(+x35.value);

  console.log(+revenue4.value);
  console.log(+x41.value);
  console.log(+x42.value);
  console.log(+x43.value);
  console.log(+x44.value);
  console.log(+x45.value);

  console.log(+revenue5.value);
  console.log(+x51.value);
  console.log(+x52.value);
  console.log(+x53.value);
